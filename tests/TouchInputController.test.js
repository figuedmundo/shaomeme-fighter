...
describe('TouchInputController', () => {
  ...
  it('should handle left zone touch as Joystick Start', () => {
    ...
    expect(mockScene.events.emit).toHaveBeenCalledWith('joystick-start', expect.anything());
  });
  ...
  it('should handle right zone touch as Attack', () => {
    ...
    expect(mockScene.events.emit).toHaveBeenCalledWith('touch-combat', expect.anything());
  });
