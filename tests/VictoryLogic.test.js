  ...
  return {
    default: {
      Scene: class {
        ...
        physics = { add: { staticGroup: vi.fn(), collider: vi.fn() }, world: { setBounds: vi.fn() }, pause: vi.fn() };
        scale = { width: 800, height: 600 };
        input = { keyboard: { createCursorKeys: vi.fn(), addKeys: vi.fn(), addKey: vi.fn() } };
      ...
      Input: { Keyboard: { KeyCodes: { SPACE: 32, W: 87, S: 83, A: 65, D: 68, F: 70 } } },
...
vi.mock('../src/components/Fighter', () => {
  const FighterState = { IDLE: 'IDLE', ATTACK: 'ATTACK', HIT: 'HIT', DIE: 'DIE' };
  return {
    default: class {
      constructor() { 
        this.health = 100; 
