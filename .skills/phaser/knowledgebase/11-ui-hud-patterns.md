...
// Top-right
this.add.text(width - 16, 16, "Time: 60", style).setOrigin(1, 0); // Anchor to top-right

// Center
this.add.text(width / 2, height / 2, "GAME OVER", style).setOrigin(0.5); // Center both axes

// Multiline centered
const lines = ["Line 1", "Line 2", "", "Line 4"];
this.add.text(centerX, centerY, lines, style).setAlign("center").setOrigin(0.5);
```
...
this.pauseText = this.add.text(centerX, centerY, "PAUSED", style).setDepth(51);
```
