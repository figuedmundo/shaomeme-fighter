...
- [x] **Photo Transitions** — Elegant fade/slide between photos `S`
- [x] **Movie Style filter** — During the photos sileshow , a movie alike filter should be displayed on top of the photos to make it more visually stunning, with option to activate/deactivat from gameData.json `M`
- [x] **Ken Burns Effect** — Slow zoom/pan on photos `S`
- [x] **Background Music** — Soft music during slideshow `S`
