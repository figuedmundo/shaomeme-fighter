...
export default class StageEffectsTestScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.rectangle(width / 2, height / 2, width, height, 0x334455);
  ...
  createDemoParallaxLayers() {
    ...
    const layers = [
      { y: 0, height: this.scale.height * 0.3, color: 0x87ceeb, scroll: 0 }, // Sky
      {
  ...
  createInstructions() {
    ...
    this.add
      .text(width - 10, height - 10, instructions.join("\n"), {
        fontSize: "12px",
        fill: "#fff",
