...
export default class WorldMapScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .text(width / 2, height / 2, "Loading cities...", {
        fontSize: "24px",
        color: "#aaaaaa",
      })
      .setOrigin(0.5);
  ...
  async fetchCities(width, height) {
    try {
      ...
      if (cities.length === 0) {
        this.add
          .text(width / 2, height / 2, "No Cities Found in /photos", {
            fontSize: "24px",
            color: "#ff0000",
          })
          .setOrigin(0.5);
      ...
      this.children.removeAll();
      this.add
        .text(width / 2, height / 2, "Error Loading Cities", {
          fontSize: "24px",
          color: "#ff0000",
        })
        .setOrigin(0.5);
