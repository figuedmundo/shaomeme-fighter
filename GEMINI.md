...
Shaomeme Fighter is a personalized mobile web fighting game built with **Phaser 3** and **Vite**, inspired by arcade classics. The game is designed primarily for iPad/iPhone and features touch-based controls ("Invisible Combat Zones"), a custom roster of characters, and "Memory Arenas" where winning unlocks photo slideshows.
